...
ai_data = download_data_from_json('rewrite_dataset/rewrite_code_by_codellama_AI_HumanEval_starcoder.json')
#human_data = download_data_from_json('rewrite_dataset/rewrite_code_by_codellama_Human_HumanEval_starcoder.json')
