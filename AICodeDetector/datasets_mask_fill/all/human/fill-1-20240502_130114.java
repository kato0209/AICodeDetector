public class TestFragment extends Fragment {
	@Override public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		RecyclerView list = (RecyclerView)inflater.inflate(R.layout.progress_item_list, container, false);
	...
	private static class ProgressViewHolder extends ViewHolder {
		...
		/** Cache target so we know the views are tied to this view holder. */
		...
		void bind(String url) {
			target.setModel(url); // update target's model, needs explicit transformation, because progress target uses a custom transformation
		}
	}
}
 ...
 * Demonstrates 3 different ways of showing the progress:
	 * <ul>
	 * <li>Update a full fledged image view to display size/percentage</li> * <li>Update a text view to display size/percentage</li>
