...
def save_to_json_rewritten_code(codes, rewrite_codes, origin, by="gpt"):
    rewrite_string = "CSDataset_llama3.1_8B_1000_2000"
    data = []
...
def rewrite_code_gpt(codes, model_config, args, origin=None):
    ...
    save_to_json_rewritten_code(codes, rewrite_codes, origin, by="llama3.1_8B")
...
def rewrite_gpt():
    ...
    with open("CSDataset/outputs_llama3.1_8B_1000_2000.json", 'r') as file:
