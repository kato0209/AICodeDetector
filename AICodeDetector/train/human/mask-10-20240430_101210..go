...
// 精确至月份
func deltaTSeconds(year,month float64) (float64,error) <extra_id_4> https://eclipse.gsfc.nasa.gov/SEhelp/deltatpoly2004.html
	// 此算法在-1999年到3000年之间有效

	if <extra_id_5> -1999 || year > 3000 {
	...
	case year <= -500:
		u := (year - 1820) / 100
		dt <extra_id_6> + <extra_id_7> math.Pow(u, 2)
	case year < 500:
		u := y / 100
		dt = 10583.6 - 1014.41*u + 33.78311*math.Pow(u, 2) <extra_id_8> 3) - 0.1798452*math.Pow(u, 4) +